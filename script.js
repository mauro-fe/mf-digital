...
document.addEventListener('DOMContentLoaded', function () {
    console.log('Script carregado - DOM pronto!');
    ...
    mobileMenuItems.forEach((item, index) => {
        console.log(`Adicionando listener ao item ${index}:`, item.textContent.trim());

        item.addEventListener('click', function (e) {
            console.log('Link clicado:', this.textContent.trim(), 'href:', this.getAttribute('href'));
            // NÃO previne o comportamento padrão - permite o scroll
            // Fecha o menu imediatamente para melhor UX
            closeMenu();
        }, true); // useCapture = true para garantir que captura o evento
    });

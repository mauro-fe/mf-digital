...
export default function Plans({ className = "" }) {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.set(".plans-card", { opacity: 0, y: 60, scale: 0.94, visibility: "hidden" });
            ...
            return (
              <div
                ...
                style={
                  isPopular
                    ? {
                        background: "linear-gradient(160deg, rgba(244,63,94,0.14) 0%, rgba(249,115,22,0.06) 50%, rgba(10,15,30,0.9) 100%)",
                        border: "1px solid rgba(244,63,94,0.35)",
                        boxShadow: "0 0 60px rgba(244,63,94,0.12), 0 20px 60px rgba(0,0,0,0.4)",
                ...
                onMouseEnter={(e) => {
                  if (!isPopular) {
                    ...
                    e.currentTarget.style.boxShadow = "0 0 30px rgba(244,63,94,0.06), 0 16px 48px rgba(0,0,0,0.3)";
                  } else {
                    e.currentTarget.style.boxShadow = "0 0 80px rgba(244,63,94,0.2), 0 30px 80px rgba(0,0,0,0.5)";
                  }
                }}
                onMouseLeave={(e) => {
                  if (!isPopular) {
                    ...
                    e.currentTarget.style.boxShadow = "0 0 60px rgba(244,63,94,0.12), 0 20px 60px rgba(0,0,0,0.4)";
                  }
                }}
              >
                ...
                {isPopular && (
                  <div
                    ...
                    style={{ background: "rgba(244,63,94,0.25)", opacity: 0.4 }}
                  />
                )}
                ...
                <div
                  ...
                  style={{
                    background: isPopular
                      ? "linear-gradient(90deg, rgba(244,63,94,0.3), rgba(249,115,22,0.2), transparent)"
                ...
                <ul className="space-y-3 mb-8">
                  {plan.features.map((f) => (
                    ...
                    >
                      ...
                      >
                        <Check size={9} className={isPopular ? "text-primary-light" : "text-gray-400"} />
                      </span>
